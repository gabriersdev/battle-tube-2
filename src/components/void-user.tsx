...
export default function VoidUser() {
  return (
    <OverlayTrigger
      ...
      <span
        className={"bg-transparent text-lowercase p-0 m-0 text-body-secondary fw-normal d-inline-flex align-items-center justify-content-start gap-1"}
        style={{fontSize: "inherit", width: "auto"}}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="11.5" height="11" fill="currentColor" className="bi bi-exclamation-circle-fill opacity-75" viewBox="0 0 16 16">
